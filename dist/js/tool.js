...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_1__["InteractsWithResourceInformation"]],
  props: {
    resourceName: String
  },
  data: function data() {
    return {
      ...
      modalOpen: false,
      importAction: null,
      errors: new laravel_nova__WEBPACK_IMPORTED_MODULE_1__["Errors"]()
    };
  },
  ...
  methods: {
    getActions: function getActions() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var _yield$window$Nova$re, actions;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return window.Nova.request().get("/nova-api/".concat(_this2.resourceName, "/actions"));

              case 2:
                _yield$window$Nova$re = _context2.sent;
                actions = _yield$window$Nova$re.data.actions;
                _this2.importAction = actions.filter(function (action) {
    ...
    executeAction: function executeAction() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        var _yield$window$Nova$re2, _data;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return window.Nova.request({
                  method: 'post',
                  url: "/nova-vendor/maatwebsite/laravel-nova-excel/".concat(_this3.resourceName, "/upload"),
                  data: _this3.form(),
                  headers: {
              ...
              case 4:
                _yield$window$Nova$re2 = _context3.sent;
                _data = _yield$window$Nova$re2.data;
              ...
              case 9:
                ...
                if (_context3.t0.response.status === 422) {
                  _this3.errors = new laravel_nova__WEBPACK_IMPORTED_MODULE_1__["Errors"](_context3.t0.response.data.errors);
                } else {
                  _this3.$toasted.show(data.message, {
                    type: "error"
                  });
                }
    ...
    form: function form() {
      ...
      this.importAction.fields.forEach(function (field) {
        field.fill(form);
      });
      return form;
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var _yield$window$Nova$re, _yield$window$Nova$re2, rows, headings, totalRows, fields;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return window.Nova.request().get("/nova-vendor/maatwebsite/laravel-nova-excel/uploads/".concat(_this.upload, "/preview"));

            case 2:
              _yield$window$Nova$re = _context.sent;
              _yield$window$Nova$re2 = _yield$window$Nova$re.data;
              rows = _yield$window$Nova$re2.rows;
              headings = _yield$window$Nova$re2.headings;
              totalRows = _yield$window$Nova$re2.totalRows;
              fields = _yield$window$Nova$re2.fields;
              _this.rows = rows;
              _this.fields = fields;
              _this.headings = headings;
              _this.rowCount = totalRows;
              _this.columnCount = rows[0].length;

              _this.headings.map(function (value, key) {
                _this.mapping[key] = '';
              });
  ...
  methods: {
    importRows: function importRows() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var _ref$response$data, errors, message;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 3;
                _context2.next = 6;
                return window.Nova.request().post("/nova-vendor/maatwebsite/laravel-nova-excel/uploads/".concat(_this2.upload, "/import"), {
                  mapping: _this2.mapping,
                  meta: _this2.meta
                });

              case 6:
                _this2.$toasted.show('All data imported!', {
                  type: "success"
                });
              ...
              case 10:
                ...
                _ref$response$data = _context2.t0.response.data;
                errors = _ref$response$data.errors;
                message = _ref$response$data.message;
                _this2.importing = false;
                ...
                _this2.errors = typeof errors !== 'undefined' ? errors : [];
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _vm.modalOpen
            ? _c(_vm.importAction.component, {
                tag: "component",
                attrs: {
                  working: _vm.working,
                  "selected-resources": "all",
                  "resource-name": _vm.resourceName,
                  action: _vm.importAction,
                  errors: _vm.errors
                },
                on: {
...
module.exports = __webpack_require__(/*! /home/dylan/projects/bizzvideo/nova/.packages/Laravel-Nova-Excel/resources/js/tool.js */"./resources/js/tool.js");
